...
class LikedPostPage extends StatefulWidget {
  ...
  @override
  State<LikedPostPage> createState() => _LikedPostPageState();
}

class _LikedPostPageState extends State<LikedPostPage> {
      ...
      body: Padding(
        ...
        child: ListView.builder(
          ...
          itemBuilder: (context, index) {
            Post item = widget.likedPosts[index];
            return Column(
                ...
                Row(
                  children: [
                    IconButton(
                      onPressed: () {
                        setState(() {
                          widget.likedPosts.removeAt(index);
                          widget.listPosts.insert(index, item);
                          item.like = false;
                        });
